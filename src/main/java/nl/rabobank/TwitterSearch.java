...
public class TwitterSearch {
   ...
   //  private static final String[] SEARCH_TERM = {"rabobank","abn amro","ingnl"};
    ...
    private static final String[] SEARCH_TERM = { "rabobank" };
    ...
    public static List<Feeds> getTweets(String searchText) {
        ...
        try {
            ...
            for (int queryNumber = 0; queryNumber < MAX_QUERIES; queryNumber++) {
                ...
                Query q = new Query(searchText); // Search for tweets that contains this term
                q.setCount(TWEETS_PER_QUERY); // How many tweets, max, to retrieve
                q.resultType(ResultType.mixed); // Get all tweets
                // q.setLang("nl"); // English language tweets, please
